...
$page_title     = "Invoice Detail - Payment";
$scriptName     = "GLDDArPymt.php";
...
if ($fromType=="")            {$dftOrderBy = array(array("ARCO","A","Company"),array("ARFAC","A","Facility"),array("ARACCT","A","Acount"),array("ARSUB","A",""));}
...
$appendUserView="N";
$appendWildCard="N";
$stmtSQL .= " SELECT Distinct ARDDSQ,ARISEQ,ARPSEQ,ARAINV,ARIVDT,ARDUED,ARSLSM,ARORD,ARPLT,ARMORD ";
$stmtSQL .= "                ,ARBLTO,ARPAYR, ARBANK, ARDTPD, ARCHK, ARSBCD ";
...
$fileSQL .= " left join ARPYSB on PSSBCD=ARSBCD ";
...
print "\n         <td class=\"colalph\" $helpCursor><span title=\"$row[ARSLSM]\">$row[SMSNA1]</span></td> ";
...
$selectSQL .= " (ARISEQ,ARPSEQ)=($invoiceSequence,$paymentSequence) ";
require 'stmtSQLSelect.php';
