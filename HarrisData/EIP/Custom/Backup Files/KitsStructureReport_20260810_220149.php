...
//
//  Both live in TWO places - the grid and the CSV export - and must be kept in
//  step. That pairing is exactly what went wrong before: Ext Qty was gated on
//  $fLevels === 'all' in the grid but written unconditionally to the CSV, so
...
<div style="padding:4px 10px;font-size:11px;color:#555;background:#FAFAFA;border-bottom:1px solid #E5E7EB;">
  ...
  status filter is applied and none is needed.
</div>
