...
<div style="padding:4px 10px;font-size:11px;color:#555;background:#FAFAFA;border-bottom:1px solid #E5E7EB;">
  ...
  <b>St</b> = <code>PSSTC</code> structure status &mdash; no status filter is applied,
  so superseded lines appear too. <b>Kit</b> = <code>IMKIT</code> (K/F/C).
</div>
...
?>
    <tr class="<?php echo $newKit ? 'ksr-newkit' : ''; ?>">
      ...
      <td class="colcode"><?php echo ksr_h(rtrim((string)$r['STAT'])); ?></td>
