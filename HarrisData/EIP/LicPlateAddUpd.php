...
$pgm = i5_program_prepare("$updProgram", $pgmCall);
if (!$pgm) {die("<br>UpdIVLPAW ($updProgram) prepare error. Error Number=".i5_errno()." msg=".i5_errormsg());}
...
if (!$ret) {die("<br>UpdIVLPAW ($updProgram) call errno=".i5_errno()." msg=".i5_errormsg());}
