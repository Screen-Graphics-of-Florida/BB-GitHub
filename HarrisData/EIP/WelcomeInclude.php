...
print "<h1>Welcome, $profileName, to the Screen Graphics $title</h1>";
...
print "<div style=\"padding: 1ex 1ex 1ex 1ex;\">";
print " <font color='#000000'> Welcome to your personalized Enterprise Information Portal! <br>
    This portal is your gateway to information in our HarrisData system. On the left, you'll find links to information you are authorized to access throughout the system. Just point, click & explore! <br>
  </div>";

echo "<img src='HarrisData\EIP\IMAGES\welcome\Nature01.gif' >";   
