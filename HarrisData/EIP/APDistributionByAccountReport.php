...
$page_title            = "A/P Distribution By G/L Account Report";
$scriptName            = "APDistributionByAccountReport.php";
$scriptVarBase         = "{$genericVarBase}&amp;backHome=" . urlencode(trim($backHome)) . "&amp;reportSelType=" . urlencode(trim($reportSelType));
$baseURL               = "{$homeURL}{$phpPath}{$scriptName}{$scriptVarBase}";
$submitNoSelection     = "";
$submitCallProgram     = "CAPDVD";
$submitEnvProgram      = "HAPDVD";
...
if ($tag == "REPORT") {
	...
	print "\n    && editNum(document.Chg.spAc01, 4, 0) ";
	print "\n    && editNum(document.Chg.spSb01, 4, 0) ";
	print "\n    && editNum(document.Chg.spFc01, 4, 0) ";

	print "\n    && editNum(document.Chg.spCo02, 2, 0) ";
	print "\n    && editNum(document.Chg.spAc02, 4, 0) ";
	print "\n    && editNum(document.Chg.spSb02, 4, 0) ";
	print "\n    && editNum(document.Chg.spFc02, 4, 0) ";

	print "\n    && editNum(document.Chg.spCo03, 2, 0) ";
	print "\n    && editNum(document.Chg.spAc03, 4, 0) ";
	print "\n    && editNum(document.Chg.spSb03, 4, 0) ";
	print "\n    && editNum(document.Chg.spFc03, 4, 0) ";

	print "\n    && editNum(document.Chg.spCo04, 2, 0) ";
	print "\n    && editNum(document.Chg.spAc04, 4, 0) ";
	print "\n    && editNum(document.Chg.spSb04, 4, 0) ";
	print "\n    && editNum(document.Chg.spFc04, 4, 0) ";

	print "\n    && editNum(document.Chg.spCo05, 2, 0) ";
	print "\n    && editNum(document.Chg.spAc05, 4, 0) ";
	print "\n    && editNum(document.Chg.spSb05, 4, 0) ";
	print "\n    && editNum(document.Chg.spFc05, 4, 0) ";

	print "\n    && editNum(document.Chg.spCo06, 2, 0) ";
	print "\n    && editNum(document.Chg.spAc06, 4, 0) ";
	print "\n    && editNum(document.Chg.spSb06, 4, 0) ";
	print "\n    && editNum(document.Chg.spFc06, 4, 0) ";

	print "\n    && editNum(document.Chg.spCo07, 2, 0) ";
	print "\n    && editNum(document.Chg.spAc07, 4, 0) ";
	print "\n    && editNum(document.Chg.spSb07, 4, 0) ";
	print "\n    && editNum(document.Chg.spFc07, 4, 0) ";

	print "\n    && editNum(document.Chg.spCo08, 2, 0) ";
	print "\n    && editNum(document.Chg.spAc08, 4, 0) ";
	print "\n    && editNum(document.Chg.spSb08, 4, 0) ";
	print "\n    && editNum(document.Chg.spFc08, 4, 0) ";

	print "\n    && editNum(document.Chg.spCo09, 2, 0) ";
	print "\n    && editNum(document.Chg.spAc09, 4, 0) ";
	print "\n    && editNum(document.Chg.spSb09, 4, 0) ";
	print "\n    && editNum(document.Chg.spFc09, 4, 0) ";

	print "\n    && editNum(document.Chg.spCo10, 2, 0) ";
	print "\n    && editNum(document.Chg.spAc10, 4, 0) ";
	print "\n    && editNum(document.Chg.spSb10, 4, 0) ";
	print "\n    && editNum(document.Chg.spFc10, 4, 0) ";

	print "\n    && editNum(document.Chg.spCo11, 2, 0) ";
	print "\n    && editNum(document.Chg.spAc11, 4, 0) ";
	print "\n    && editNum(document.Chg.spSb11, 4, 0) ";
	print "\n    && editNum(document.Chg.spFc11, 4, 0) ";

	print "\n    && editNum(document.Chg.spCo12, 2, 0) ";
	print "\n    && editNum(document.Chg.spAc12, 4, 0) ";
	print "\n    && editNum(document.Chg.spSb12, 4, 0) ";
	...
	if ($errFound != "" || $scheduleJobSwitch == "Y") {
		...
		if ($errFound != "") {
			...
			$Err_AC01=DecatErr_Field("@@ac01", "spAc01");
			$Err_SB01=DecatErr_Field("@@sb01", "spSb01");
			$Err_FC01=DecatErr_Field("@@fc01", "spFc01");

			$Err_CO02=DecatErr_Field("@@co02", "spCo02");
			$Err_AC02=DecatErr_Field("@@ac02", "spAc02");
			$Err_SB02=DecatErr_Field("@@sb02", "spSb02");
			$Err_FC02=DecatErr_Field("@@fc02", "spFc02");

			$Err_CO03=DecatErr_Field("@@co03", "spCo03");
			$Err_AC03=DecatErr_Field("@@ac03", "spAc03");
			$Err_SB03=DecatErr_Field("@@sb03", "spSb03");
			$Err_FC03=DecatErr_Field("@@fc03", "spFc03");

			$Err_CO04=DecatErr_Field("@@co04", "spCo04");
			$Err_AC04=DecatErr_Field("@@ac04", "spAc04");
			$Err_SB04=DecatErr_Field("@@sb04", "spSb04");
			$Err_FC04=DecatErr_Field("@@fc04", "spFc04");

			$Err_CO05=DecatErr_Field("@@co05", "spCo05");
			$Err_AC05=DecatErr_Field("@@ac05", "spAc05");
			$Err_SB05=DecatErr_Field("@@sb05", "spSb05");
			$Err_FC05=DecatErr_Field("@@fc05", "spFc05");

			$Err_CO06=DecatErr_Field("@@co06", "spCo06");
			$Err_AC06=DecatErr_Field("@@ac06", "spAc06");
			$Err_SB06=DecatErr_Field("@@sb06", "spSb06");
			$Err_FC06=DecatErr_Field("@@fc06", "spFc06");

			$Err_CO07=DecatErr_Field("@@co07", "spCo07");
			$Err_AC07=DecatErr_Field("@@ac07", "spAc07");
			$Err_SB07=DecatErr_Field("@@sb07", "spSb07");
			$Err_FC07=DecatErr_Field("@@fc07", "spFc07");

			$Err_CO08=DecatErr_Field("@@co08", "spCo08");
			$Err_AC08=DecatErr_Field("@@ac08", "spAc08");
			$Err_SB08=DecatErr_Field("@@sb08", "spSb08");
			$Err_FC08=DecatErr_Field("@@fc08", "spFc08");

			$Err_CO09=DecatErr_Field("@@co09", "spCo09");
			$Err_AC09=DecatErr_Field("@@ac09", "spAc09");
			$Err_SB09=DecatErr_Field("@@sb09", "spSb09");
			$Err_FC09=DecatErr_Field("@@fc09", "spFc09");

			$Err_CO10=DecatErr_Field("@@co10", "spCo10");
			$Err_AC10=DecatErr_Field("@@ac10", "spAc10");
			$Err_SB10=DecatErr_Field("@@sb10", "spSb10");
			$Err_FC10=DecatErr_Field("@@fc10", "spFc10");

			$Err_CO11=DecatErr_Field("@@co11", "spCo11");
			$Err_AC11=DecatErr_Field("@@ac11", "spAc11");
			$Err_SB11=DecatErr_Field("@@sb11", "spSb11");
			$Err_FC11=DecatErr_Field("@@fc11", "spFc11");

			$Err_CO12=DecatErr_Field("@@co12", "spCo12");
			$Err_AC12=DecatErr_Field("@@ac12", "spAc12");
			$Err_SB12=DecatErr_Field("@@sb12", "spSb12");
		...
		$AC01=Decat_Field("@@ac01", $edtVar);
		$SB01=Decat_Field("@@sb01", $edtVar);
		$FC01=Decat_Field("@@fc01", $edtVar);

		$CO02=Decat_Field("@@co02", $edtVar);
		$AC02=Decat_Field("@@ac02", $edtVar);
		$SB02=Decat_Field("@@sb02", $edtVar);
		$FC02=Decat_Field("@@fc02", $edtVar);

		$CO03=Decat_Field("@@co03", $edtVar);
		$AC03=Decat_Field("@@ac03", $edtVar);
		$SB03=Decat_Field("@@sb03", $edtVar);
		$FC03=Decat_Field("@@fc03", $edtVar);

		$CO04=Decat_Field("@@co04", $edtVar);
		$AC04=Decat_Field("@@ac04", $edtVar);
		$SB04=Decat_Field("@@sb04", $edtVar);
		$FC04=Decat_Field("@@fc04", $edtVar);

		$CO05=Decat_Field("@@co05", $edtVar);
		$AC05=Decat_Field("@@ac05", $edtVar);
		$SB05=Decat_Field("@@sb05", $edtVar);
		$FC05=Decat_Field("@@fc05", $edtVar);

		$CO06=Decat_Field("@@co06", $edtVar);
		$AC06=Decat_Field("@@ac06", $edtVar);
		$SB06=Decat_Field("@@sb06", $edtVar);
		$FC06=Decat_Field("@@fc06", $edtVar);

		$CO07=Decat_Field("@@co07", $edtVar);
		$AC07=Decat_Field("@@ac07", $edtVar);
		$SB07=Decat_Field("@@sb07", $edtVar);
		$FC07=Decat_Field("@@fc07", $edtVar);

		$CO08=Decat_Field("@@co08", $edtVar);
		$AC08=Decat_Field("@@ac08", $edtVar);
		$SB08=Decat_Field("@@sb08", $edtVar);
		$FC08=Decat_Field("@@fc08", $edtVar);

		$CO09=Decat_Field("@@co09", $edtVar);
		$AC09=Decat_Field("@@ac09", $edtVar);
		$SB09=Decat_Field("@@sb09", $edtVar);
		$FC09=Decat_Field("@@fc09", $edtVar);

		$CO10=Decat_Field("@@co10", $edtVar);
		$AC10=Decat_Field("@@ac10", $edtVar);
		$SB10=Decat_Field("@@sb10", $edtVar);
		$FC10=Decat_Field("@@fc10", $edtVar);

		$CO11=Decat_Field("@@co11", $edtVar);
		$AC11=Decat_Field("@@ac11", $edtVar);
		$SB11=Decat_Field("@@sb11", $edtVar);
		$FC11=Decat_Field("@@fc11", $edtVar);

		$CO12=Decat_Field("@@co12", $edtVar);
		$AC12=Decat_Field("@@ac12", $edtVar);
		$SB12=Decat_Field("@@sb12", $edtVar);
	...
	print "\n       <td class=\"quickLinkTabs\"><a href=\"#Specific\">Specific G/L Account Entry</a></td> ";
	print "\n   </tr> ";
	print "\n </table> ";
	print $hrTagAttr;
	...
	print "\n <a name=\"Specific\"></a> ";
	print "\n <fieldset class=\"legendBody\"> ";
	print "\n     <legend class=\"legendTitle\">Specific G/L Account Entry</legend> ";
	require 'TopOfForm.php';
	print "\n     <table $contentTable> ";

	print "\n         <tr><td class=\"colhdr\">Co-Acct_Sub-Fac</td> ";
	print "\n             <td class=\"colhdr\">Co-Acct_Sub-Fac</td> ";
	print "\n             <td class=\"colhdr\">Co-Acct_Sub-Fac</td> ";
	print "\n         </tr> ";
	...
	print "\n                                   - <input type=\"text\" name=\"spAc01\" value=\"$AC01\" size=\"4\" maxlength=\"4\">";
	print "\n                                   - <input type=\"text\" name=\"spSb01\" value=\"$SB01\" size=\"4\" maxlength=\"4\">";
	print "\n                                   - <input type=\"text\" name=\"spFc01\" value=\"$FC01\" size=\"4\" maxlength=\"4\">";
	print "\n                                     <a href=\"{$homeURL}{$phpPath}GLAccountSearch.php{$genericVarBase}&amp;docName=Chg&amp;fldCo=spCo01&amp;fldFac=spFc01&amp;fldAcct=spAc01&amp;fldSub=spSb01&amp;fldDesc=none\" onclick=\"$searchWinVar\">$searchImage </a></td> ";
	print "\n             <td class=\"inputnmbr\"><input type=\"text\" name=\"spCo02\" value=\"$CO02\" size=\"2\" maxlength=\"2\">";
	print "\n                                   - <input type=\"text\" name=\"spAc02\" value=\"$AC02\" size=\"4\" maxlength=\"4\">";
	print "\n                                   - <input type=\"text\" name=\"spSb02\" value=\"$SB02\" size=\"4\" maxlength=\"4\">";
	print "\n                                   - <input type=\"text\" name=\"spFc02\" value=\"$FC02\" size=\"4\" maxlength=\"4\">";
	print "\n                                     <a href=\"{$homeURL}{$phpPath}GLAccountSearch.php{$genericVarBase}&amp;docName=Chg&amp;fldCo=spCo02&amp;fldFac=spFc02&amp;fldAcct=spAc02&amp;fldSub=spSb02&amp;fldDesc=none\" onclick=\"$searchWinVar\">$searchImage </a></td> ";
	print "\n             <td class=\"inputnmbr\"><input type=\"text\" name=\"spCo03\" value=\"$CO03\" size=\"2\" maxlength=\"2\">";
	print "\n                                   - <input type=\"text\" name=\"spAc03\" value=\"$AC03\" size=\"4\" maxlength=\"4\">";
	print "\n                                   - <input type=\"text\" name=\"spSb03\" value=\"$SB03\" size=\"4\" maxlength=\"4\">";
	print "\n                                   - <input type=\"text\" name=\"spFc03\" value=\"$FC03\" size=\"4\" maxlength=\"4\">";
	print "\n                                     <a href=\"{$homeURL}{$phpPath}GLAccountSearch.php{$genericVarBase}&amp;docName=Chg&amp;fldCo=spCo03&amp;fldFac=spFc03&amp;fldAcct=spAc03&amp;fldSub=spSb03&amp;fldDesc=none\" onclick=\"$searchWinVar\">$searchImage </a></td> ";
	print "\n         </tr> ";
	DspErrMsg($Err_CO01);
	DspErrMsg($Err_CO02);
	DspErrMsg($Err_CO03);
	...
	print "\n                                   - <input type=\"text\" name=\"spAc04\" value=\"$AC04\" size=\"4\" maxlength=\"4\">";
	print "\n                                   - <input type=\"text\" name=\"spSb04\" value=\"$SB04\" size=\"4\" maxlength=\"4\">";
	print "\n                                   - <input type=\"text\" name=\"spFc04\" value=\"$FC04\" size=\"4\" maxlength=\"4\">";
	print "\n                                     <a href=\"{$homeURL}{$phpPath}GLAccountSearch.php{$genericVarBase}&amp;docName=Chg&amp;fldCo=spCo04&amp;fldFac=spFc04&amp;fldAcct=spAc04&amp;fldSub=spSb04&amp;fldDesc=none\" onclick=\"$searchWinVar\">$searchImage </a></td> ";
	print "\n             <td class=\"inputnmbr\"><input type=\"text\" name=\"spCo05\" value=\"$CO05\" size=\"2\" maxlength=\"2\">";
	print "\n                                   - <input type=\"text\" name=\"spAc05\" value=\"$AC05\" size=\"4\" maxlength=\"4\">";
	print "\n                                   - <input type=\"text\" name=\"spSb05\" value=\"$SB05\" size=\"4\" maxlength=\"4\">";
	print "\n                                   - <input type=\"text\" name=\"spFc05\" value=\"$FC05\" size=\"4\" maxlength=\"4\">";
	print "\n                                     <a href=\"{$homeURL}{$phpPath}GLAccountSearch.php{$genericVarBase}&amp;docName=Chg&amp;fldCo=spCo05&amp;fldFac=spFc05&amp;fldAcct=spAc05&amp;fldSub=spSb05&amp;fldDesc=none\" onclick=\"$searchWinVar\">$searchImage </a></td> ";
	print "\n             <td class=\"inputnmbr\"><input type=\"text\" name=\"spCo06\" value=\"$CO06\" size=\"2\" maxlength=\"2\">";
	print "\n                                   - <input type=\"text\" name=\"spAc06\" value=\"$AC06\" size=\"4\" maxlength=\"4\">";
	print "\n                                   - <input type=\"text\" name=\"spSb06\" value=\"$SB06\" size=\"4\" maxlength=\"4\">";
	print "\n                                   - <input type=\"text\" name=\"spFc06\" value=\"$FC06\" size=\"4\" maxlength=\"4\">";
	print "\n                                     <a href=\"{$homeURL}{$phpPath}GLAccountSearch.php{$genericVarBase}&amp;docName=Chg&amp;fldCo=spCo06&amp;fldFac=spFc06&amp;fldAcct=spAc06&amp;fldSub=spSb06&amp;fldDesc=none\" onclick=\"$searchWinVar\">$searchImage </a></td> ";
	print "\n         </tr> ";
	DspErrMsg($Err_CO04);
	DspErrMsg($Err_CO05);
	DspErrMsg($Err_CO06);
	...
	print "\n                                   - <input type=\"text\" name=\"spAc07\" value=\"$AC07\" size=\"4\" maxlength=\"4\">";
	print "\n                                   - <input type=\"text\" name=\"spSb07\" value=\"$SB07\" size=\"4\" maxlength=\"4\">";
	print "\n                                   - <input type=\"text\" name=\"spFc07\" value=\"$FC07\" size=\"4\" maxlength=\"4\">";
	print "\n                                     <a href=\"{$homeURL}{$phpPath}GLAccountSearch.php{$genericVarBase}&amp;docName=Chg&amp;fldCo=spCo07&amp;fldFac=spFc07&amp;fldAcct=spAc07&amp;fldSub=spSb07&amp;fldDesc=none\" onclick=\"$searchWinVar\">$searchImage </a></td> ";
	print "\n             <td class=\"inputnmbr\"><input type=\"text\" name=\"spCo08\" value=\"$CO08\" size=\"2\" maxlength=\"2\">";
	print "\n                                   - <input type=\"text\" name=\"spAc08\" value=\"$AC08\" size=\"4\" maxlength=\"4\">";
	print "\n                                   - <input type=\"text\" name=\"spSb08\" value=\"$SB08\" size=\"4\" maxlength=\"4\">";
	print "\n                                   - <input type=\"text\" name=\"spFc08\" value=\"$FC08\" size=\"4\" maxlength=\"4\">";
	print "\n                                     <a href=\"{$homeURL}{$phpPath}GLAccountSearch.php{$genericVarBase}&amp;docName=Chg&amp;fldCo=spCo08&amp;fldFac=spFc08&amp;fldAcct=spAc08&amp;fldSub=spSb08&amp;fldDesc=none\" onclick=\"$searchWinVar\">$searchImage </a></td> ";
	print "\n             <td class=\"inputnmbr\"><input type=\"text\" name=\"spCo09\" value=\"$CO09\" size=\"2\" maxlength=\"2\">";
	print "\n                                   - <input type=\"text\" name=\"spAc09\" value=\"$AC09\" size=\"4\" maxlength=\"4\">";
	print "\n                                   - <input type=\"text\" name=\"spSb09\" value=\"$SB09\" size=\"4\" maxlength=\"4\">";
	print "\n                                   - <input type=\"text\" name=\"spFc09\" value=\"$FC09\" size=\"4\" maxlength=\"4\">";
	print "\n                                     <a href=\"{$homeURL}{$phpPath}GLAccountSearch.php{$genericVarBase}&amp;docName=Chg&amp;fldCo=spCo09&amp;fldFac=spFc09&amp;fldAcct=spAc09&amp;fldSub=spSb09&amp;fldDesc=none\" onclick=\"$searchWinVar\">$searchImage </a></td> ";
	print "\n         </tr> ";
	DspErrMsg($Err_CO07);
	DspErrMsg($Err_CO08);
	DspErrMsg($Err_CO09);
	...
	print "\n                                   - <input type=\"text\" name=\"spAc10\" value=\"$AC10\" size=\"4\" maxlength=\"4\">";
	print "\n                                   - <input type=\"text\" name=\"spSb10\" value=\"$SB10\" size=\"4\" maxlength=\"4\">";
	print "\n                                   - <input type=\"text\" name=\"spFc10\" value=\"$FC10\" size=\"4\" maxlength=\"4\">";
	print "\n                                     <a href=\"{$homeURL}{$phpPath}GLAccountSearch.php{$genericVarBase}&amp;docName=Chg&amp;fldCo=spCo10&amp;fldFac=spFc10&amp;fldAcct=spAc10&amp;fldSub=spSb10&amp;fldDesc=none\" onclick=\"$searchWinVar\">$searchImage </a></td> ";
	print "\n             <td class=\"inputnmbr\"><input type=\"text\" name=\"spCo11\" value=\"$CO11\" size=\"2\" maxlength=\"2\">";
	print "\n                                   - <input type=\"text\" name=\"spAc11\" value=\"$AC11\" size=\"4\" maxlength=\"4\">";
	print "\n                                   - <input type=\"text\" name=\"spSb11\" value=\"$SB11\" size=\"4\" maxlength=\"4\">";
	print "\n                                   - <input type=\"text\" name=\"spFc11\" value=\"$FC11\" size=\"4\" maxlength=\"4\">";
	print "\n                                     <a href=\"{$homeURL}{$phpPath}GLAccountSearch.php{$genericVarBase}&amp;docName=Chg&amp;fldCo=spCo11&amp;fldFac=spFc11&amp;fldAcct=spAc11&amp;fldSub=spSb11&amp;fldDesc=none\" onclick=\"$searchWinVar\">$searchImage </a></td> ";
	print "\n             <td class=\"inputnmbr\"><input type=\"text\" name=\"spCo12\" value=\"$CO12\" size=\"2\" maxlength=\"2\">";
	print "\n                                   - <input type=\"text\" name=\"spAc12\" value=\"$AC12\" size=\"4\" maxlength=\"4\">";
	print "\n                                   - <input type=\"text\" name=\"spSb12\" value=\"$SB12\" size=\"4\" maxlength=\"4\">";
	print "\n                                   - <input type=\"text\" name=\"spFc12\" value=\"$FC12\" size=\"4\" maxlength=\"4\">";
	print "\n                                     <a href=\"{$homeURL}{$phpPath}GLAccountSearch.php{$genericVarBase}&amp;docName=Chg&amp;fldCo=spCo12&amp;fldFac=spFc12&amp;fldAcct=spAc12&amp;fldSub=spSb12&amp;fldDesc=none\" onclick=\"$searchWinVar\">$searchImage </a></td> ";
	print "\n         </tr> ";
	DspErrMsg($Err_CO10);
	DspErrMsg($Err_CO11);
	DspErrMsg($Err_CO12);
...
if ($tag == "Edit_Data") {
	...
	Concat_Field("@@ac01", $_POST['spAc01']);
	Concat_Field("@@sb01", $_POST['spSb01']);
	Concat_Field("@@fc01", $_POST['spFc01']);

	Concat_Field("@@co02", $_POST['spCo02']);
	Concat_Field("@@ac02", $_POST['spAc02']);
	Concat_Field("@@sb02", $_POST['spSb02']);
	Concat_Field("@@fc02", $_POST['spFc02']);

	Concat_Field("@@co03", $_POST['spCo03']);
	Concat_Field("@@ac03", $_POST['spAc03']);
	Concat_Field("@@sb03", $_POST['spSb03']);
	Concat_Field("@@fc03", $_POST['spFc03']);

	Concat_Field("@@co04", $_POST['spCo04']);
	Concat_Field("@@ac04", $_POST['spAc04']);
	Concat_Field("@@sb04", $_POST['spSb04']);
	Concat_Field("@@fc04", $_POST['spFc04']);

	Concat_Field("@@co05", $_POST['spCo05']);
	Concat_Field("@@ac05", $_POST['spAc05']);
	Concat_Field("@@sb05", $_POST['spSb05']);
	Concat_Field("@@fc05", $_POST['spFc05']);

	Concat_Field("@@co06", $_POST['spCo06']);
	Concat_Field("@@ac06", $_POST['spAc06']);
	Concat_Field("@@sb06", $_POST['spSb06']);
	Concat_Field("@@fc06", $_POST['spFc06']);

	Concat_Field("@@co07", $_POST['spCo07']);
	Concat_Field("@@ac07", $_POST['spAc07']);
	Concat_Field("@@sb07", $_POST['spSb07']);
	Concat_Field("@@fc07", $_POST['spFc07']);

	Concat_Field("@@co08", $_POST['spCo08']);
	Concat_Field("@@ac08", $_POST['spAc08']);
	Concat_Field("@@sb08", $_POST['spSb08']);
	Concat_Field("@@fc08", $_POST['spFc08']);

	Concat_Field("@@co09", $_POST['spCo09']);
	Concat_Field("@@ac09", $_POST['spAc09']);
	Concat_Field("@@sb09", $_POST['spSb09']);
	Concat_Field("@@fc09", $_POST['spFc09']);

	Concat_Field("@@co10", $_POST['spCo10']);
	Concat_Field("@@ac10", $_POST['spAc10']);
	Concat_Field("@@sb10", $_POST['spSb10']);
	Concat_Field("@@fc10", $_POST['spFc10']);

	Concat_Field("@@co11", $_POST['spCo11']);
	Concat_Field("@@ac11", $_POST['spAc11']);
	Concat_Field("@@fc11", $_POST['spFc11']);
	Concat_Field("@@sb11", $_POST['spSb11']);

	Concat_Field("@@co12", $_POST['spCo12']);
	Concat_Field("@@ac12", $_POST['spAc12']);
	Concat_Field("@@sb12", $_POST['spSb12']);
	Concat_Field("@@fc12", $_POST['spFc12']);

	require 'ScheduleJobConcat.php';   // Schedule Entries Values
	$edtVar .= "}{";

	$returnValue=Selection_Edit_Handle("HAPDRS_WA", $profileHandle, $dataBaseID, $submitSchedule, $errFound, $edtVar, $errVar, $wrnVar);
