...
$page_title = "Employee Synchronization";
$scriptName = "EmployeeSync.php";
...
if ($tag != "EXPORT") {
    ...
    if ($formatToPrint != "Y") {
        print "\n <td class=\"toolbar\">";
        if ($sec_01 == "Y" && $sec_02 == "Y" && $AppsInHd != '') {
            print "\n <a href=\"{$homeURL}{$phpPath}EmployeeSyncSelection.php{$genericVarBase}\">{$addImageLrg}</a>";
        }
...
if ($formatToPrint == "") {
    $qsOpt = "\n <option value=\"ATDESCU|null|Last Change|A|U\" title=\"Description\" SELECTED>Last Change";
...
print "\n <th class=\"colhdr$sortVar\"><a href=\"{$baseURL}&amp;tag=ORDERBY&amp;sequence=Desc\" title=\"Sequence By Last Change, Attachment Name\">{$sortPoint}Last Change</a></th>";
