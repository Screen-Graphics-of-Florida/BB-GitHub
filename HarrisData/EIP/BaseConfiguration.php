...
$libraryList= array("SGHDSDATA","HDSMODPGM","HDSSTDPGM","AVATAXR2","SGPGM","SG","QTEMP","DRVSFLEX","QGPL","INFOPRINT","HSSF","RPGMAIL","PROITRG","C3","SEQUEL","ROBOTLIB","CGIDEV2","ZENDSVR6");
$chgLibraryList= (string) "CHGLIBL LIBL( SGHDSDATA HDSMODPGM HDSSTDPGM AVATAXR2 SGPGM SG QTEMP DRVSFLEX QGPL INFOPRINT HSSF RPGMAIL PROITRG C3 SEQUEL ROBOTLIB CGIDEV2 ZENDSVR6)";
