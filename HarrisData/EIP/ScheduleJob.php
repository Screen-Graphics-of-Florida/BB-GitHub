...
if ($submitSchedule == "S") {
	...
	print "\n                             <a href=\"{$homeURL}{$phpPath}FlagSearch.php{$genericVarBase}&amp;flagType=SCHFREQPHP&amp;flagSrchHdr=" . urlencode("Frequency") . "&amp;docName=Chg&amp;fldName=schFrequency&amp;fldDesc=schFrequencyDesc\" onclick=\"$searchWinVar\"> $reqFieldChar $searchImage</a></td>  ";
	print "\n </tr> ";
