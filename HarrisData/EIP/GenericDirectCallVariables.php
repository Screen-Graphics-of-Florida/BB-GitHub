...
function Retrieve_User_Selection ($profileHandle, $dataBaseID, $maintCode, $userProfile, $selectName, $selectSequence, $selectDesc, $selectTotals, $selectGroupBy, $selectCriteria) {
    global $pgmLibrary, $i5Connect;
    if (!$i5Connect) die("<br>Retrieve User Selection Connection Failed. Error number =".i5_errno()." msg=".i5_errormsg());

    $pgmCall = array(
        array("Name"=>"profileHandle",  "IO"=>I5_INOUT, "Type"=>I5_TYPE_CHAR,   "Length"=>"64"),
        array("Name"=>"dataBaseID",     "IO"=>I5_INOUT, "Type"=>I5_TYPE_CHAR,   "Length"=>"2"),
        array("Name"=>"maintCode",      "IO"=>I5_INOUT, "Type"=>I5_TYPE_CHAR,   "Length"=>"1"),
        array("Name"=>"userProfile",    "IO"=>I5_INOUT, "Type"=>I5_TYPE_CHAR,   "Length"=>"10"),
        array("Name"=>"selectName",     "IO"=>I5_INOUT, "Type"=>I5_TYPE_CHAR,   "Length"=>"10"),
        array("Name"=>"selectSequence", "IO"=>I5_INOUT, "Type"=>I5_TYPE_PACKED, "Length"=>"5.0"),
        array("Name"=>"selectDesc",     "IO"=>I5_INOUT, "Type"=>I5_TYPE_CHAR,   "Length"=>"50"),
        array("Name"=>"selectTotals",   "IO"=>I5_INOUT, "Type"=>I5_TYPE_CHAR,   "Length"=>"10"),
        array("Name"=>"selectGroupBy",  "IO"=>I5_INOUT, "Type"=>I5_TYPE_CHAR,   "Length"=>"500"),
        array("Name"=>"selectCriteria", "IO"=>I5_INOUT, "Type"=>I5_TYPE_CHAR,   "Length"=>"3000"));

    $pgmName = "HSYUSL_W";
    $pgm = i5_program_prepare("$pgmName", $pgmCall);
    if (!$pgm) {die("<br>Retrieve_User_Selection ($pgmName) prepare error. Error Number=".i5_errno()." msg=".i5_errormsg());}
    ...
    $ret = i5_program_call($pgm, $parmIn, $parmOut);
    if (function_exists('i5_output')) extract(i5_output());
    if (!$ret) {die("<br>Retrieve_User_Selection ($pgmName) call errno=".i5_errno()." msg=".i5_errormsg());}

    $returnValue['profileHandle']  =$profileHandle;
    $returnValue['dataBaseID']     =$dataBaseID;
    $returnValue['maintCode']      =$maintCode;
    $returnValue['userProfile']    =$userProfile;
    $returnValue['selectName']     =$selectName;
    $returnValue['selectSequence'] =$selectSequence;
    $returnValue['selectDesc']     =$selectDesc;
    $returnValue['selectTotals']   =$selectTotals;
    $returnValue['selectGroupBy']  =$selectGroupBy;
    $returnValue['selectCriteria'] =$selectCriteria;
    return $returnValue;
}

function Retrieve_Group_Desc ($profileHandle, $dataBaseID, $selectName, $selectSequence, $grpFldLvl, $grpFldTyp, $grpFldHdr, $grpFldVal, $grpFldDsc, $selectGroup, $selectGroupSQL) {
    global $pgmLibrary, $i5Connect;
    if (!$i5Connect) die("<br>Retrieve Group Description Connection Failed. Error number =".i5_errno()." msg=".i5_errormsg());

    $pgmCall = array(
        array("Name"=>"profileHandle",  "IO"=>I5_IN,    "Type"=>I5_TYPE_CHAR,   "Length"=>"64"),
        array("Name"=>"dataBaseID",     "IO"=>I5_IN,    "Type"=>I5_TYPE_CHAR,   "Length"=>"2"),
        array("Name" => "selectName",   "IO"=>I5_INOUT, "Type"=>I5_TYPE_CHAR,   "Length" => "10"),
        array("Name"=>"selectSequence", "IO"=>I5_IN,    "Type"=>I5_TYPE_PACKED, "Length"=>"5.0"),
	    array("Name"=>"grpFldLvl",      "IO"=>I5_IN,    "Type"=>I5_TYPE_PACKED, "Length"=>"3.0"),
        array("Name"=>"grpFldTyp",      "IO"=>I5_IN,    "Type"=>I5_TYPE_CHAR,   "Length"=>"10"),
	    array("Name"=>"grpFldHdr",      "IO"=>I5_IN,    "Type"=>I5_TYPE_CHAR,   "Length"=>"50"),
	    array("Name"=>"grpFldVal",      "IO"=>I5_IN,    "Type"=>I5_TYPE_CHAR,   "Length"=>"50"),
	    array("Name"=>"grpFldDsc",      "IO"=>I5_IN,    "Type"=>I5_TYPE_CHAR,   "Length"=>"50"),
        array("Name"=>"selectGroup",    "IO"=>I5_IN,    "Type"=>I5_TYPE_CHAR,   "Length"=>"50"),
        array("Name"=>"selectGroupSQL", "IO"=>I5_INOUT, "Type"=>I5_TYPE_CHAR,   "Length"=>"500"));

    $pgmName = "HSYUSG_W";
    $pgm = i5_program_prepare("$pgmName", $pgmCall);
    if (!$pgm) {die("<br>Retrieve_Group_Desc ($pgmName) prepare error. Error Number=".i5_errno()." msg=".i5_errormsg());}
    ...
    $ret = i5_program_call($pgm, $parmIn, $parmOut);
    if (function_exists('i5_output')) extract(i5_output());
    if (!$ret) {die("<br>Retrieve_Group_Desc ($pgmName) call errno=".i5_errno()." msg=".i5_errormsg());}
 
    return $selectGroupSQL;
}

function Update_User_Selection($profileHandle,$dataBaseID,$maintCode,$userProfile,$selectName,$selectSequence,$selectDesc,$selectTotals,$selectGroupBy,$selectCriteria,$deleteUser) {
    global $allUsers, $genericVarBase, $pgmLibrary, $i5Connect;

    $pgmCall = array(array("Name" => "profileHandle",  "IO" => I5_IN,    "Type" => I5_TYPE_CHAR,   "Length" => "64"),
        array("Name" => "dataBaseID",     "IO" => I5_IN,    "Type" => I5_TYPE_CHAR,   "Length" => "2"),
        array("Name" => "maintCode",      "IO" => I5_IN,    "Type" => I5_TYPE_CHAR,   "Length" => "1"),
        array("Name" => "userProfile",    "IO" => I5_IN,    "Type" => I5_TYPE_CHAR,   "Length" => "10"),
        array("Name" => "selectName",     "IO" => I5_INOUT, "Type" => I5_TYPE_CHAR,   "Length" => "10"),
        array("Name" => "selectSequence", "IO" => I5_INOUT, "Type" => I5_TYPE_PACKED, "Length" => "5.0"),
        array("Name" => "selectDesc",     "IO" => I5_INOUT, "Type" => I5_TYPE_CHAR,   "Length" => "50"),
    ...
    $pgm = i5_program_prepare($pgmName, $pgmCall);
    if (!$pgm) {
        die("<br>Update_User_Selection ($pgmName) prepare error. Error Number=" . i5_errno() . " msg=" . i5_errormsg());
    }
    ...
    if (function_exists('i5_output')) extract(i5_output());
    if (!$ret) {
        die("<br>Update_User_Selection ($pgmName) call errno=" . i5_errno() . " msg=" . i5_errormsg());
    }
    if ($maintCode !== "D") {
        $returnValue['selectSequence'] = $selectSequence;
        $returnValue['selectDesc']     = $selectDesc;
	...
	return $returnValue;
        ...
        $confMessage = "Confirm Delete of Inquiry {$deleteUser}: '{$selectDesc}'";
        return $confMessage;
    }
}
