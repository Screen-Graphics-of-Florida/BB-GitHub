...
print "\n <tr class=\"bannerdiv\">";
print "<td colspan=\"2\">";
print     " \n <a href=\"http://www.harrisdata.com/Home.htm\" title=\"HarrisData home page\" class=\"banner\">Home</a>";
print      "|";
print     "\n <a href=\"http://www.harrisdata.com/Contact.htm\" title=\"Contact HarrisData\" class=\"banner\">Contact Us</a>";
print  "\n |";
...
$logo1 =  "$homePath" ."images/hdlogo2-harris-X.gif";
...
print "\n <tr>";
if ($logo1Exists=="Y"){
print "<td class=\"menu\"><img src=\"images/hdlogo2-harris-X.gif\" width=\"89\" height=\"32\" alt=\"HarrisData\" title=\"HarrisData\" border=\"0\"></td>";
}
if ($logo2Exists=="Y"){
