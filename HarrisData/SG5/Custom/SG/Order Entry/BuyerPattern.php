    ...
    if ($what === 'sku') {
        ...
        foreach ($skuList as $s) {
            ...
            fputcsv($out, array($s['item'], $s['desc'],
                                ...
                                // Whole units, matching the screen. Bill, 2026-09-02:
                                // BuyerPattern CSVs carry no decimals on quantities.
                                // (The Kits Structure Report export is the deliberate
                                // exception and keeps its decimals - do not "align" it.)
                                ($xAv === null ? '' : number_format($xAv, 0, '.', '')),
                                ($xOo === null ? '' : number_format($xOo, 0, '.', '')),
                                ($xPr === null ? '' : number_format($xPr, 0, '.', '')),
