...
.filter-group select            { width: 190px; }
...
/* ── Table ── */
table { border-collapse: collapse; min-width: 1480px; width: 100%; }
...
<div class="refresh-bar">
  ...
  <div class="refresh-progress"><div class="refresh-fill" id="molr-prog" style="width:100%"></div></div>
  <span>Next refresh in: <strong id="molr-cd">10m 0s</strong></span>
...
<table id="molr-grid">
  <colgroup>
    ...
    <col class="c-mo"><col class="c-wc"><col class="c-wdesc">
...
<?php if (!empty($rows)): ?>
  ...
  <tr class="totals-row" data-totals="1">
    ...
    <td class="R"><?php echo molr_dec($tot['CALCSUHRS']); ?></td>
    <td></td>
