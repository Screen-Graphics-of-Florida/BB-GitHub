...
// S5HDSDATA (SG5 test environment)
// NOTE: PPTX file must exist at W:\HarrisData\SG5\Custom\SG\
//       Customer_Service_Inquiry_Training_Guide_06-2026.pptx
//       for the link to be downloadable from SG5.
//
// URL: https://portal.screen-graphics.com:5610/Custom/SG/AddCSInqTrainingToSGDoc.php?confirm=ADD
...
<p style="color:#2e7d32;font-weight:bold">
  Done. Verify the new item appears on the SG Documentation page in EIP.<br>
  <em>Note: copy the PPTX to W:\HarrisData\SG5\Custom\SG\ to make the download
  work from the SG5 test portal.</em>
</p>
<?php endif; ?>
</body>
</html>
