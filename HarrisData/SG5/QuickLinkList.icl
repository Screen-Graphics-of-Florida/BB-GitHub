...
**********************************************************************
%}
  @dtw_tb_rows(quicklinkSeqTable, linkCount)
  %if (linkCount > "0")
      ...
      %endif
      @dtw_divrem(linkCount, linksPerRow, remainder)
      @dtw_intdiv(linkCount, linksPerRow, cellCount)
      @dtw_add(cellCount, remainder, cellCount)
              ...
              <td class="qllist">
                  <ul class="qllist">
                      ...
                      %while (x <= quicklinkCount) {
                          ...
                          %else
                              @dtw_assign(classOverride, "qllist")
                          %endif
