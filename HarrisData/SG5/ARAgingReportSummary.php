...
$page_title            = "Summary Aged Accounts Receivable Report";
$scriptName            = "ARAgingReportSummary.php";
$scriptVarBase         = "{$genericVarBase}&amp;backHome=" . urlencode(trim($backHome)) . "&amp;reportSelType=" . urlencode(trim($reportSelType));
$baseURL               = "{$homeURL}{$phpPath}{$scriptName}{$scriptVarBase}";
$submitNoSelection     = "";
$submitCallProgram     = "CARAG5";
$submitEnvProgram      = "HARAG5";
$submitEnvPrinter      = "HARAG5PF";
...
if ($tag == "WILDCARD" || $tag == "Edit_Data") {
	...
	$returnValue=Selection_Edit_Handle("HARSAG_WS", $profileHandle, $dataBaseID, $submitSchedule, $errFound, $edtVar, $errVar, $wrnVar);
