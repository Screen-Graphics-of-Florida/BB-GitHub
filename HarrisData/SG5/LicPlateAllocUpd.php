...
if (!$pgm) {die("<br>UpdOELPWK ($updProgram) prepare error. Error Number=".i5_errno()." msg=".i5_errormsg());}
...
if (!$ret) {die("<br>UpdOELPWK ($updProgram) call errno=".i5_errno()." msg=".i5_errormsg());}
