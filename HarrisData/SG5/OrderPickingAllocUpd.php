...
if (!$pgm) {die("<br>UpdOEOPQS ($updProgram) prepare error. Error Number=".i5_errno()." msg=".i5_errormsg());}
...
if (!$ret) {die("<br>UpdOEOPQS ($updProgram) call errno=".i5_errno()." msg=".i5_errormsg());}
