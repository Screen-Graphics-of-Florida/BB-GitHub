...
$page_title = "Customer Synchronization";
$scriptName = "CustomerSync.php";
...
if ($tag != "EXPORT") {
    ...
    if ($formatToPrint != "Y") {
        print "\n <td class=\"toolbar\">";
        if ($sec_01 == "Y" && $sec_02 == "Y" && $AppsInHdERP != '') {
            print "\n <a href=\"{$homeURL}{$phpPath}CustomerSyncUpdate.php{$genericVarBase}\">{$addImageLrg}</a>";
        }
