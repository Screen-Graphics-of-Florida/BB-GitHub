...
print "\n     if (customerInUse > 0) {alert(\"Customer not available. Refresh page for more information.\");return false;} ";
...
print "\n     var selTable =\"ARPYRH inner join ARPYRC on PCPAYR=PYPAYR inner join HDCUSI on CICUST=PCCUST and CIIUSR<>' ' and (CIIBCH<>" . $fromBatchNumber . " or CIIDTE<>" . $fromBatchDate . " or CIIBNK<>" . $fromBatchBank  . " or CIIUSR<>'" . trim($userProfile)  . "' or CITYPE<>'" . $fromType  . "' or CIID<>\" + C  +\" ) \"; ";
print "\n     var selColumn=\"Char(Count(*))\"; ";
print "\n     var retVal=\"\"; ";
print "\n     var payerInUse=RetValueAjax(selWhere,selTable, selColumn, retVal); ";
print "\n     if (payerInUse > 0) {alert(\"Payer not available. Refresh page for more information.\");return false;} ";
print "\n     else                {PayerAddHDCUSI(C);return true;} ";
print "\n   } ";
print "\n } ";
