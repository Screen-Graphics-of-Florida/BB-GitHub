			                   ...
			                   CHAR(3)   fldType)
{
  ...
  %if (fromData != "" || toData != "")
      ...
      %elif (fldType == "D" && operand != "BETWEEN")
      ...
      %elif (fldType == "DP" && operand != "BETWEEN")
          @dtw_assign(fromDate, fromData)
          @dtw_insert(dateEdit,  fromDate, "2", "1",  fromDate)
          @PeriodToCYP(fromData)
          @dtw_concat(wildDisplayTemp, "$(fldDesc) $(displayOper) $(fromDate)", wildDisplayTemp)
          @dtw_concat(wildCardTemp, " $(fldName) $(operand) $(fromData)", wildCardTemp)
      ...
      %elif (fldType == "TSD" && operand != "BETWEEN")
          %if (sysDateFormat == "YMD")
              @dtw_assign(fromFormat, "*YMD")
          %elif (sysDateFormat == "DMY")
              @dtw_assign(fromFormat, "*DMY")
          %else
      ...
      %elif (fldType == "TST" && ((operand == "=" || operand == "<>") && (@dtw_rlength(fromData) == "3" || @dtw_rlength(fromData) == "4")))
      ...
      %elif (fldType == "TST" && operand != "BETWEEN")
      ...
      %elif (fldType == "N" && operand != "BETWEEN")
          @dtw_concat(wildDisplayTemp, "$(fldDesc) $(displayOper) $(fromData)", wildDisplayTemp)
          @dtw_concat(wildCardTemp, " $(fldName) $(operand) $(fromData)", wildCardTemp)
